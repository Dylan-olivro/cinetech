...
<head>
    ...
    <script src="./js/detail2.js" defer></script>
    <!-- BOOTSTRAP -->
...
<body>
    ...
    <main id="detail">
        ...
        <section id="detailMedia">
            ...
            <div id="infoMedia">
                ...
                <form action="" method="post" id="formFavoris">
                    <button type="submit" name="favoris" id="btnFavoris"></button>
                </form>
            </div>
        </section>
        ...
        <section id="similarMedia"></section>
        ...
        <section id="commentaireMedia">
            ...
            <?php
                if (isset($_POST['submit'])) {
                    ...
                    header('Location: ./detail2.php?id=' . $_GET['id'] . '&type=' . $_GET['type'] . '');
                }
    ...
    if (isset($_SESSION['user'])) {
        ...
        if (empty($resultFavoris)) { ?>
            <script>
                ...
                btnFavoris.textContent = 'Ajouter'
            </script>
        <?php
        } else { ?>
            <script>
                btnFavoris.textContent = 'Enlever'
            </script>
    <?php
        }
    }
